...
Set-Location C:\Dev\naj-market-pulse
$log = "logs\finish_naming_$(Get-Date -Format yyyyMMdd_HHmm).log"
...
foreach ($s in @("scripts\resolve_identity.py","scripts\apply_identity.py","scripts\build_unit_mix.py","scripts\plot_points.py","scripts\build_search_index.py","scripts\twin_audit.py")) {
